    ...
    d.flexslider = function (j, l) {
        ...
        f = {
            init: function () {
                ...
                setup: function () {
                    var b = d('<ul class="' +
                        e + 'direction-nav"><li><a class="' + e + 'prev " href="#">' + c.prevText + '<i class="fa fa-angle-left"></i>' + '</a></li><li><a class="' + e + 'next" href="#">' + c.nextText + '<i class="fa fa-angle-right"></i>' + "</a></li></ul>");
